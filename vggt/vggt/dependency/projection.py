...
def img_from_cam_np(
    intrinsics: np.ndarray, points_cam: np.ndarray, extra_params: Union[np.ndarray,None] = None, default: float = 0.0
) -> np.ndarray:
    """
...
def project_3D_points_np(
    ...
    intrinsics: Union[np.ndarray,None] = None,
    extra_params: Union[np.ndarray,None] = None,
    *,
    default: float = 0.0,
